 ...
 * @LastEditTime: 2021-02-07 11:48:51
 * @FilePath: /hos-logistics-management/src/views/procurement/purchaseOrder/detail.vue
-->
  ...
  <ContainerGroup id="containerGroup">
      ...
      <div class="form-row">
        <el-row>
          <el-form :model="formInfo" ref="formInfo" :rules="rules">
            ...
            <el-col :span="6">
              <el-form-item label="状态：" prop="amount" label-width="115px">
    ...
    <Container>
      ...
      :summary-method="getSummaries" stripe size="mini" highlight-current-row isFillHeight height="0">
        ...
        <el-table-column label="申请数量" align="center" prop="requestQuantity"></el-table-column>
        <el-table-column label="采购数量" align="center" prop="orderQuantity">
          <template slot-scope="scope">
            <el-input v-model="scope.row.orderQuantity" type="number" :min="0" @input="_quanlityOrPriceChange(scope.row,scope.$index)"></el-input>
          </template>
        </el-table-column>
        <el-table-column label="已采购数量" align="center" prop="storedQuantity"></el-table-column>
        ...
        <el-table-column label="供应商" align="center" prop="supplierCode">
          <template slot-scope="scope">
            <el-select v-model="scope.row.supplierCode">
              <el-option v-for="item in supplierList" :key="item.code" :value="item.code" :label="item.name"></el-option>
            </el-select>
          </template>
        </el-table-column>
    ...
    <el-dialog :visible="backVisible" class="dialog-wrapper" width="35%" title='采购退货审批驳回' :before-close="_itemHandleClose">
      <div>
        <p><span style='color:red;'>*</span> 审批意见：</p>
        <el-input type="textarea" placeholder="请输入最多200个字符" :maxlength="200"></el-input>
      </div>
      <div style="text-align:center; border-top:1px solid #e5e5e5;padding-top:10px;margin-top:10px;">
