    ...
    <Container height="fill" scrollY="true" style="box-shadow:none">
        ...
        <div class="card-div">
          <div class="ul p-clear">
            <div class="li" v-for="(item,index) in tableData" :key="index">
              <div class="li-head">
                <span class="icon"></span>
                <span class="title">电梯巡检</span>
                <span class="progress">待巡检</span>
              </div>
              <div class="li-info">
                ...
                <div class="cate-name">
                  <span class="sp">设备名称：</span>
                  <span>电梯</span>
                </div>
                <div class="worker">
                  <span class="sp">巡检频率：</span>
                  <span class="sp2">1周3次</span>
                </div>
                <div class="com-name">
              ...
              <div class="li-bottom">
                <span title="任务反馈"><i class="iconfont">&#xe6b7;</i></span>
                <span title="查看详情"><i class="iconfont">&#xe66f;</i></span>
                <span title="任务列表"><i class="iconfont">&#xe652;</i></span>
                <span title="设备报修"><i class="iconfont">&#xe653;</i></span>
                <span title="任务转单"><i class="iconfont">&#xe65a;</i></span>
                <span title="去巡检"><i class="iconfont">&#xe658;</i></span>
              </div>
            </div>
          </div>
        </div>
