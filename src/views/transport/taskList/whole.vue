  ...
  <ContainerGroup>
    <Container>
      <el-form :model="formInline" :inline="true" ref="formInline" label-width="90px">
        ...
        <el-form-item label="任务类型：">
          <el-select placeholder="请选择" clearable v-model="formInline.taskList" style="width:100%;">
            <el-option v-for="(item,index) in taskList" :key="index" :value="item.dictId" :label="item.name"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="单据来源：" v-show="showAll">
          ...
          <!-- <el-select placeholder="请选择" clearable v-model="formInline.sourceList" style="width:100%;">
              <el-option v-for="(item,index) in sourceList" :key="index" :value="item.supplierId" :label="item.name"></el-option>
            </el-select> -->
        </el-form-item>
        ...
        <el-form-item label="提交时间：" v-show="showAll">
    ...
    <Container>
      ...
      <el-table height="0" @selection-change="handleSelectionChange" :data="tableData" border v-loading="loading" :header-cell-style="{ background: '#FAFAFA', height: '42px' }" stripe size="mini" highlight-current-row isFillHeight>
        ...
        <el-table-column label="护工人员" show-overflow-tooltip prop="nursingUserNameList">
    ...
    methods: {
      ...
      _getData() {
        ...
        let parms = {
          ...
          taskType: this.formInline.taskList,
          ...
          startCreateTime: this.formInline.submitDate[0],
          endCreateTime: this.formInline.submitDate[1],
