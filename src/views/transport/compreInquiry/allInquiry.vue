<template>
  <ContainerGroup>
    ...
    <Container>
      ...
      <el-table isFillHeight stripe size="mini" :header-cell-style="{ background: '#FAFAFA', height: '42px' }" :data="tableData" height="0" border v-loading="loading" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="任务状态" prop="orderStatusName"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      _toDetailHandle(row) {
        console.log('row', row)
        console.log(this.initInfo.dictId)
        this.$router.push({
