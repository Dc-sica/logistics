 ...
 * @LastEditTime: 2021-02-07 11:39:13
 * @FilePath: /hos-logistics-management/src/views/procurement/purchaseReturns/edit.vue
-->
...
<template>
  <ContainerGroup id="containerGroup">
    <Container>
        <el-button type="primary" @click="_saveHandle">保存</el-button>
          ...
          <template slot-scope="scope">
            <el-tooltip class="item"
              ...
              <el-popconfirm :title="`确定要删除 ${scope.row.materialName} 吗?`"
                @confirm="_deleteHandle(scope.row,scope.$index)">
                <el-button type="text"
                  slot="reference">
