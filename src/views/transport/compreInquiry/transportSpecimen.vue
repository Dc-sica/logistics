<template>
  <ContainerGroup>
    ...
    <Container>
      ...
      <el-table isFillHeight stripe size="mini" :header-cell-style="{ background: '#FAFAFA', height: '42px' }" :data="tableData" :height="tableHeight" border v-loading="loading" @selection-change="handleSelectionChange">
