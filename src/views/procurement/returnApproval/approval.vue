 ...
 * @LastEditTime: 2021-02-07 11:38:48
 * @FilePath: /hos-logistics-management/src/views/procurement/returnApproval/approval.vue
-->
<template>
  <ContainerGroup id="containerGroup">
    <Container>
          <el-button type="primary"
            @click="_approvalHandle">同意</el-button>
          <el-button type="primary"
            @click="_backHandle">驳回</el-button>
          <el-button type="default" @click="_cancelHandle">返回</el-button>
    </Container>
    <Container>
      <p class="form-title">
        采购退货审批
          ...
          <el-form :model="formInfo"
            ...
            <el-col :span="6">
              <el-form-item label="申请人："
                prop="approvalName"
                label-width="115px">
                <el-input v-model="formInfo.approvalName"
                  disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
          ...
          <template slot-scope="scope">
            <el-tooltip class="item"
              ...
              <el-popconfirm :title="`确定要删除 ${scope.row.materialName} 吗?`"
                @confirm="_deleteItem(scope.row,scope.$index)">
                <el-button type="text"
                  slot="reference">
...
import { getReturnDetail, approvalItem } from './../../../apis/purchaseApproval/index'
export default {
  name: 'setting',
  data () {
    return {
