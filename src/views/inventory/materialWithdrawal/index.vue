  ...
  <ContainerGroup>
    <Container>
      <el-form :inline="true" :model="formInline" ref="formInline">
        ...
        <el-form-item label="领用人：" label-width="82px" prop="applicantName">
          <el-input
        ...
        <el-form-item label="退库状态：" prop="approvalStatus">
          <el-select
            placeholder="请选择"
            clearable
    ...
    <Container>
      ...
      >
        ...
        <el-table-column
          ...
          prop="approvalTime"
        ></el-table-column>
        <el-table-column label="确认日期" prop="postTime"></el-table-column>
        <el-table-column label="备注" prop="remark"></el-table-column>
        <el-table-column label="领用状态" prop="approvalStatus">
        ...
        <el-table-column label="过账状态" prop="applicationStatus">
          <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    _addItemHandle() {
      this.$router.push("/materialWithdrawal/add");
    },
      ...
      if (this.excelBtns === "1") {
        exportMaterialCollection(params).then((res) => {
          if (res.status === 201) {
            ...
            downloadLink.download = "物资退库.xlsx";
            downloadLink.click();
