  ...
  <ContainerGroup>
    ...
    <Container>
      ...
      <el-table :data="tableData" border @selection-change="handleSelectionChange" :header-cell-style="{background:'#E8EAED'}" stripe size="mini" highlight-current-row isFillHeight height="0">
        ...
        <el-table-column label="采购订单号" show-overflow-tooltip prop="name"></el-table-column>
        <el-table-column label="申请人" show-overflow-tooltip prop="code"></el-table-column>
        <el-table-column label="申请部门" prop="contacts"></el-table-column>
        <el-table-column label="入库仓库" show-overflow-tooltip prop="phone"></el-table-column>
        <el-table-column label="录单日期" prop="bank"></el-table-column>
        <el-table-column label="发票号" show-overflow-tooltip prop="bankAccount"></el-table-column>
        <el-table-column label="合计金额（元）" show-overflow-tooltip prop="address"></el-table-column>
        <el-table-column label="供应商" show-overflow-tooltip prop="contactsEmail"></el-table-column>
        <el-table-column label="过账日期" prop="legalPerson"></el-table-column>
