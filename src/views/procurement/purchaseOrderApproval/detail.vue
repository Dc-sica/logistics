      ...
      <div class="form-row">
        <el-row>
          <el-form :model="formInfo" ref="formInfo" :rules="rules">
            ...
            <el-col :span="12">
              <el-form-item label="审批意见：" prop="remarks" label-width="115px">
                <el-input type="textarea" v-model="formInfo.approvalComments" disabled placeholder="请输入审批意见,不超过300字" maxlength="300"></el-input>
              </el-form-item>
            </el-col>
          </el-form>
        </el-row>
