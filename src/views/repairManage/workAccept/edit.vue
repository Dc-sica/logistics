        ...
        <div class="form-row p-clear">
          <el-col :span="12">
            <div class="group p-clear">
              ...
              <el-input class="inp h40" disabled v-model="name"></el-input>
            </div>
          </el-col>
          <el-col :span="24">
            <div class="group p-clear">
              <span class="sp"><i class="red">* </i>审批意见：</span>
              <el-input type="textarea" class="text" placeholder="请输入描述，不超过300字" show-word-limit :rows="4" v-model="remark" :maxlength="300"></el-input>
            </div>
          </el-col>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      _reject() {
        ...
        repairOrderHandler(parms).then(res => {
          if (res.data.code === 200) {
