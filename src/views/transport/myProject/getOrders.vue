<template>
  <ContainerGroup class="wrapper">
    <Container>
      ...
      <el-button round
        type="primary"
        v-if="orderStatus === '4' && orderType === '3'"
        @click="_onSubmit">接单</el-button>
      <el-button round
        type="primary"
        v-if="orderStatus === '4' && orderType === '1'"
        @click="_robSubmit">抢单</el-button>
    </Container>
    <Container class="wrapper-table" height="fill" scrollY="true">
      <div class="form-box">
        ...
        <p class="form-title bt" v-show="orderStatus === '4'">
          护工人员信息
        </p>
        <div class="form-row p-clear">
          <el-col :span="12">
...
<script>
import { selectTaskOrderByTaskTypes, operationOrder } from './../../../apis/projectRegister/indexApi'
...
export default {
  ...
  mounted () {
    const { userId, nursingGroupId } = JSON.parse(localStorage.getItem('userInfo'))
    this.userId = userId
